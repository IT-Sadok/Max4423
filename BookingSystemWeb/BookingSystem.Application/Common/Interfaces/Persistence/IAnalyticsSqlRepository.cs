...
{
    Task<IEnumerable<HostPortfolioDto>> GetLargeHostsPortfolioAsync(CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<ApartmentOccupancyDto>> GetApartmentOccupancyAsync(DateTime startDate, DateTime endDate, CancellationToken cancellationToken = default);
}